  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 hover:shadow-md transition-all duration-200 group">
      <div className="flex items-start justify-between mb-3">
        <p className="text-sm font-medium text-slate-500 tracking-wide uppercase" style={{ fontSize: '11px', letterSpacing: '0.08em' }}>
          {title}
        </p>
        {Icon && (
      ...
      <div className="flex items-end gap-3">
        <span className="text-4xl font-bold font-display text-slate-900 leading-none tracking-tight">
          {displayValue}
        </span>
        {delta != null && (
          <div className={cn(
            'flex items-center gap-1 text-xs font-semibold px-2 py-1 rounded-lg mb-0.5',
