...
async function runQueries() {
  try {
    ...
    if (leadResult.rows.length === 0) {
      ...
      console.log(`   Event Date: ${lead.eventDate ? lead.eventDate.toISOString().split('T')[0] : null}`);
      ...
      if (lead.eventDate && lead.eventDate.toISOString().includes('2025-06-15')) console.log('   ✓ eventDate is 2025-06-15');
      else console.log(`   ✗ eventDate is ${lead.eventDate?.toISOString()}, expected 2025-06-15`);
